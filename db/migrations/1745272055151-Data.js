module.exports = class Data1745272055151 {
    name = 'Data1745272055151'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "name" text, "stash" text, "reward" text, "creator" text, "root" text, "toggler" text, "nominator" text, "total_bonded" numeric, "status" character varying(9), CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
