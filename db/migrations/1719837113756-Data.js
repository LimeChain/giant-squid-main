module.exports = class Data1719837113756 {
    name = 'Data1719837113756'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "staker" ("id" character varying NOT NULL, "role" character varying(9) NOT NULL, "total_bonded" numeric NOT NULL, "total_unbonded" numeric NOT NULL, "total_withdrawn" numeric NOT NULL, "total_slashed" numeric NOT NULL, "stash_id" character varying, "payee_id" character varying, CONSTRAINT "REL_828b14269265a736e4fef52ce2" UNIQUE ("stash_id"), CONSTRAINT "PK_13561f691b22038cfa606fe1161" PRIMARY KEY ("id"))`)
