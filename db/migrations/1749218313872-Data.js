module.exports = class Data1749218313872 {
    name = 'Data1749218313872'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "xcm_transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "to" jsonb, "to_chain" text, "amount" jsonb, "asset" jsonb, "weight_limit" numeric, "call" text NOT NULL, "contract_called" text, "contract_input" text, "account_id" character varying, CONSTRAINT "PK_51dd82383f8ec7d2358b8df0859" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_a6e19d0c7bdc44737e0f3c800b" ON "xcm_transfer" ("contract_called") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_a6e19d0c7bdc44737e0f3c800b"`)
