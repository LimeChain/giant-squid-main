module.exports = class Data1745402423833 {
    name = 'Data1745402423833'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "xcm_transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "fee_asset_item" integer NOT NULL, "to" text NOT NULL, "amount" numeric NOT NULL, "weight_limit" numeric, "call" character varying(30) NOT NULL, "from_id" character varying, "to_chain_id" character varying, CONSTRAINT "PK_51dd82383f8ec7d2358b8df0859" PRIMARY KEY ("id"))`)
