// @ts-ignore
import { Account, NominationPoolsUnbound, Pool, PoolStatus, Staker } from '@/model';
...
export interface INominationPoolsUnbondedEventPalletDecoder
  extends IEventPalletDecoder<{ member: string; poolId: number; balance: bigint; points: bigint; era: number }> {}
