...
export class LimitedReserveTransferAssetsCallDecoder implements ILimitedReserveTransferAssetsPalletDecoder {
  decode(call: Call) {
    ...
    if (limitedReserveTransferAssets.v1201.is(call)) {
      const data = limitedReserveTransferAssets.v1201.decode(call);
    ...
    } else if (limitedReserveTransferAssets.v2201.is(call)) {
      const data = limitedReserveTransferAssets.v2201.decode(call);
    ...
    } else if (limitedReserveTransferAssets.v2302.is(call)) {
      const data = limitedReserveTransferAssets.v2302.decode(call);
    ...
    } else if (limitedReserveTransferAssets.v2901.is(call)) {
      const data = limitedReserveTransferAssets.v2901.decode(call);
