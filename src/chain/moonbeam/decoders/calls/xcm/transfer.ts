import {
  V2WeightLimit,
  VersionedMultiAssets_V0 as VersionedMultiAssets_V0_V1201,
  VersionedMultiAssets_V1 as VersionedMultiAssets_V1_V1201,
  VersionedMultiLocation_V0 as VersionedMultiLocation_V0_V1201,
  VersionedMultiLocation_V1 as VersionedMultiLocation_V1_V1201,
} from '@/chain/moonbeam/types/v1201';
import {
  VersionedMultiAssets_V0 as VersionedMultiAssets_V0_V2201,
  VersionedMultiAssets_V1 as VersionedMultiAssets_V1_V2201,
  VersionedMultiLocation_V0 as VersionedMultiLocation_V0_V2201,
  VersionedMultiLocation_V1 as VersionedMultiLocation_V1_V2201,
} from '@/chain/moonbeam/types/v2201';
import {
  VersionedMultiAssets_V2 as VersionedMultiAssets_V2_V2302,
  VersionedMultiAssets_V3 as VersionedMultiAssets_V3_V2302,
  VersionedMultiLocation_V2 as VersionedMultiLocation_V2_V2302,
  VersionedMultiLocation_V3 as VersionedMultiLocation_V3_V2302,
} from '@/chain/moonbeam/types/v2302';
import {
  V3WeightLimit,
  VersionedAssets_V2 as VersionedAssets_V2_V2901,
  VersionedAssets_V3 as VersionedAssets_V3_V2901,
  VersionedAssets_V4 as VersionedAssets_V4_V2901,
  VersionedLocation_V2 as VersionedLocation_V2_V2901,
  VersionedLocation_V3 as VersionedLocation_V3_V2901,
  VersionedLocation_V4 as VersionedLocation_V4_V2901,
} from '@/chain/moonbeam/types/v2901';
import {
  V2Instruction_DepositAsset,
  V3Instruction_DepositAsset,
  VersionedAssets_V2 as VersionedAssets_V2_V3100,
  VersionedAssets_V3 as VersionedAssets_V3_V3100,
  VersionedAssets_V4 as VersionedAssets_V4_V3100,
  VersionedLocation_V2 as VersionedLocation_V2_V3100,
  VersionedLocation_V3 as VersionedLocation_V3_V3100,
  VersionedLocation_V4 as VersionedLocation_V4_V3100,
  VersionedXcm_V2,
  VersionedXcm_V3,
  VersionedXcm_V4,
} from '@/chain/moonbeam/types/v3100';

export function decodeV0Dest(dest: VersionedMultiLocation_V0_V1201 | VersionedMultiLocation_V0_V2201): { parachainDestination: string } {
...
export function decodeV1ToV3Dest(
  dest:
    | VersionedMultiLocation_V1_V1201
    | VersionedMultiLocation_V1_V2201
    | VersionedMultiLocation_V2_V2302
    | VersionedLocation_V2_V2901
    | VersionedMultiLocation_V3_V2302
    | VersionedLocation_V3_V2901
    | VersionedLocation_V2_V3100
    | VersionedLocation_V3_V3100
...
export function decodeV4Dest(dest: VersionedLocation_V4_V2901 | VersionedLocation_V4_V3100): { parachainDestination: string } {
  let parachainDestination: string = '';
...
export function decodeV0Beneficiary(_beneficiary: VersionedMultiLocation_V0_V1201 | VersionedMultiLocation_V0_V2201): {
...
export function decodeV4Beneficiary(_beneficiary: VersionedLocation_V4_V2901): {
  beneficiaryKey: string;
} {
  let beneficiaryKey: string = '';
...
export function decodeV0Assets(_assets: VersionedMultiAssets_V0_V1201 | VersionedMultiAssets_V0_V2201): {
  amount: bigint;
} {
...
export function decodeV1ToV3Assets(
  _assets:
    | VersionedMultiAssets_V1_V1201
    | VersionedMultiAssets_V1_V2201
    | VersionedMultiAssets_V2_V2302
    | VersionedMultiAssets_V3_V2302
    | VersionedAssets_V2_V2901
    | VersionedAssets_V3_V2901
    | VersionedAssets_V2_V3100
    | VersionedAssets_V3_V3100
): { amount: bigint } {
  let amount: bigint = 0n;
...
export function decodeV4Assets(_assets: VersionedAssets_V4_V2901 | VersionedAssets_V4_V3100): {
  amount: bigint;
} {
  let amount: bigint = 0n;

  // Only support fun.__kind === 'Fungible' (most common)
  if (_assets.value[0].fun.__kind === 'Fungible') {
    amount = _assets.value[0].fun.value;
  }
