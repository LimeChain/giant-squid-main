import {
  V2WeightLimit,
  VersionedMultiAssets_V0 as VersionedMultiAssets_V0_V49,
  VersionedMultiAssets_V1 as VersionedMultiAssets_V1_V49,
  VersionedMultiLocation_V0 as VersionedMultiLocation_V0_V49,
  VersionedMultiLocation_V1 as VersionedMultiLocation_V1_V49,
} from '@/chain/shiden/types/v49';
import {
  VersionedMultiAssets_V0 as asVersionedMultiAssets_V0_V90,
  VersionedMultiAssets_V1 as asVersionedMultiAssets_V1_V90,
  VersionedMultiLocation_V0 as VersionedMultiLocation_V0_V90,
  VersionedMultiLocation_V1 as VersionedMultiLocation_V1_V90,
} from '@/chain/shiden/types/v90';
import {
  VersionedMultiAssets_V2 as VersionedMultiAssets_V2_V95,
  VersionedMultiAssets_V3 as VersionedMultiAssets_V3_V95,
  VersionedMultiLocation_V2 as VersionedMultiLocation_V2_V95,
  VersionedMultiLocation_V3 as VersionedMultiLocation_V3_V95,
} from '@/chain/shiden/types/v96';
import {
  V3WeightLimit,
  VersionedAssets_V2 as VersionedAssets_V2_V130,
  VersionedAssets_V3 as VersionedAssets_V3_V130,
  VersionedAssets_V4 as VersionedAssets_V4_V130,
  VersionedLocation_V2 as VersionedLocation_V2_V130,
  VersionedLocation_V3 as VersionedLocation_V3_V130,
  VersionedLocation_V4 as VersionedLocation_V4_V130,
} from '@/chain/shiden/types/v130';

export function decodeV0Dest(dest: VersionedMultiLocation_V0_V49 | VersionedMultiLocation_V0_V90): { parachainDestination: string } {
...
export function decodeV1ToV3Dest(
  dest:
    | VersionedMultiLocation_V1_V49
    | VersionedMultiLocation_V1_V90
    | VersionedMultiLocation_V2_V95
    | VersionedLocation_V2_V130
    | VersionedMultiLocation_V3_V95
    | VersionedLocation_V3_V130
...
export function decodeV4Dest(dest: VersionedLocation_V4_V130): { parachainDestination: string } {
  let parachainDestination: string = '';
...
export function decodeV0Beneficiary(_beneficiary: VersionedMultiLocation_V0_V49 | VersionedMultiLocation_V0_V90): {
...
export function decodeV4Beneficiary(_beneficiary: VersionedLocation_V4_V130): {
  beneficiaryKey: string;
} {
  let beneficiaryKey: string = '';
...
export function decodeV0Assets(_assets: VersionedMultiAssets_V0_V49 | asVersionedMultiAssets_V0_V90): {
  amount: bigint;
} {
...
export function decodeV1ToV3Assets(
  _assets:
    | VersionedMultiAssets_V1_V49
    | asVersionedMultiAssets_V1_V90
    | VersionedMultiAssets_V2_V95
    | VersionedMultiAssets_V3_V95
    | VersionedAssets_V2_V130
    | VersionedAssets_V3_V130
): { amount: bigint } {
  let amount: bigint = 0n;
...
export function decodeV4Assets(_assets: VersionedAssets_V4_V130): {
  amount: bigint;
} {
  let amount: bigint = 0n;
