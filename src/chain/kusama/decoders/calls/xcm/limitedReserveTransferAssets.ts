...
export class LimitedReserveTransferAssetsCallDecoder implements ILimitedReserveTransferAssetsPalletDecoder {
  decode(call: Call) {
    ...
    if (limitedReserveTransferAssets.v9122.is(call)) {
      const data = limitedReserveTransferAssets.v9122.decode(call);
    ...
    } else if (limitedReserveTransferAssets.v9381.is(call)) {
      const data = limitedReserveTransferAssets.v9381.decode(call);
    ...
    } else if (limitedReserveTransferAssets.v1005000.is(call)) {
      const data = limitedReserveTransferAssets.v1005000.decode(call);
