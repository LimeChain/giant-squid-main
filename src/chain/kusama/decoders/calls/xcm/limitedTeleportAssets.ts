...
export class LimitedTeleportAssetsCallDecoder implements ILimitedTeleportAssetsPalletDecoder {
  decode(call: Call) {
    ...
    if (limitedTeleportAssets.v9122.is(call)) {
      const data = limitedTeleportAssets.v9122.decode(call);
    ...
    } else if (limitedTeleportAssets.v9381.is(call)) {
      const data = limitedTeleportAssets.v9381.decode(call);
    ...
    } else if (limitedTeleportAssets.v1005000.is(call)) {
      const data = limitedTeleportAssets.v1005000.decode(call);
