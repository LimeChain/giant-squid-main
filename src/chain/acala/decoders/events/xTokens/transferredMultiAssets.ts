...
import { V1Junction_Parachain, V1MultiAsset, V1MultiLocation } from '@/chain/acala/types/v2032';
import { V1MultiAsset as V1MultiAssetV2040, V1MultiLocation as V1MultiLocationV2040 } from '@/chain/acala/types/v2040';
import { V3MultiAsset, V3MultiLocation } from '@/chain/acala/types/v2180';
import { V3MultiAsset as V3MultiAssetV2240, V3MultiLocation as V3MultiLocationV2240 } from '@/chain/acala/types/v2240';
...
function getTo(destination: V1MultiLocation) {
  ...
  if (destination.interior.__kind === 'X2') {
    ...
    switch (target?.__kind) {
      ...
      case 'GeneralKey':
        return target.value;
      // return (target as V1Junction_GeneralKey)
    }
  }
...
function getAssetAmounts(assets: (V1MultiAsset | V3MultiAsset | V3MultiAssetV2240)[]) {
