...
import { V1Junction_Parachain, V1MultiAsset, V1MultiLocation } from '@/chain/integritee/types/integriteeParachainV18';
import { V3MultiAsset, V3MultiLocation } from '@/chain/integritee/types/integriteeParachainV35';
