...
import { V1MultiLocation, V2Instruction, V2Instruction_BuyExecution } from '@/chain/robonomics/types/v20';
import { V3MultiLocation, V3Instruction, V3Instruction_BuyExecution } from '@/chain/robonomics/types/v32';
