...
function decodeV4Dest(dest: VersionedLocation_V4_V100200): { parachainDestination: string } {
  let parachainDestination: string = '';
...
function decodeV4Beneficiary(_beneficiary: VersionedLocation_V4_V100200): {
  beneficiaryKey: string;
} {
  let beneficiaryKey: string = '';
...
function decodeV4Assets(_assets: VersionedAssets_V4_V100200): {
  amount: bigint;
} {
  let amount: bigint = 0n;
