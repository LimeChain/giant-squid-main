...
import { TransferEventPalletDecoder } from '@/chain/litentry/decoders/events/balances/transfer';
import { ParachainStakingCandidateBondedLessEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/candidateBondedLess';
import { ParachainStakingCandidateBondedMoreEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/candidateBondedMore';
import { ParachainStakingCandidateLeftEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/candidateLeft';
import { ParachainStakingCompoundEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/compounded';
import { ParachainStakingDelegationEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/delegation';
import { ParachainStakingDelegationDecreasedEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/delegationDecreased';
import { ParachainStakingDelegationIncreasedEventPalletDecoder } from '@/chain/litentry/decoders/events/parachain-staking/delegationIncreased';
